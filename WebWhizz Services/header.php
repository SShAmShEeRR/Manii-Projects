...
<nav class="flex items-center justify-between px-4 md:px-8 py-6 max-w-7xl mx-auto bg-white relative z-50">
    ...
    <div class="flex items-center gap-2 cursor-pointer" onclick="window.location.href='index.php'">
        ...
        <!-- Force text-black so it is visible on all pages -->
        <span class="text-xl font-bold tracking-tight font-sans text-black">WebWhizz Services</span>
    </div>

    <!-- Center Menu (Hidden on mobile) -->
    <div class="hidden md:flex items-center gap-10 font-medium text-sm">
         <!-- Active Link (Home) -->
         <a href="index.php" class="relative text-black font-semibold hover:text-lime-600 transition-colors">
            Home
         </a>

         <!-- Services Dropdown Container -->
         <div class="relative group">
            <a href="services.php" class="flex items-center gap-1 text-gray-500 hover:text-black transition-colors py-2">
                Services
                <!-- Down Arrow Icon -->
            ...
            <!-- Dropdown Menu -->
            <div class="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-72 bg-white rounded-2xl shadow-xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform group-hover:translate-y-0 translate-y-2 overflow-hidden text-left">
                <div class="py-2">
         ...
         <a href="blog.php" class="text-gray-500 hover:text-black transition-colors">Blog</a>
         <!-- Added About Us Button -->
         <a href="about-us.php" class="text-gray-500 hover:text-black transition-colors">About Us</a>
    </div>

    <!-- CTA Button (Added 'text-black' class) -->
    <a href="contact-us.php" class="border border-gray-300 px-6 py-2.5 rounded-full text-xs font-bold text-black hover:bg-black hover:text-white transition-colors">
        Contact Us
    </a>
</nav>